...
var XpiInstaller = {
	...
	extFullName: 'Firemago', // The name displayed to the user (don't include the version)
	extShortName: 'firemago', // The leafname of the JAR file (without the .jar part)
	extVersion: '2.4',
	extAuthor: 'glupglup',
	extLocaleNames: null, // e.g. ['en-US', 'en-GB']
	extSkinNames: null, // e.g. ['classic', 'modern']
	extPostInstallMessage: 'Installation réussie ! Redémarrez votre navigateur pour terminer l\'installation.', // Set to null for no post-install message
	// --- Editable items end ---
